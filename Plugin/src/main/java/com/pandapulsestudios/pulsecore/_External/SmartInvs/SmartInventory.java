...
import com.pandapulsestudios.pulsecore._External.SmartInvs.content.InventoryProvider;
...
public class SmartInventory {
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryManager manager = this.manager != null ? this.manager : PulseCore.SmartInvsPlugin.manager();
